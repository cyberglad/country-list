...
public class SortedCountryList {
    ...
    //Locale outLocale = new Locale(lang);
		...
		otherCountryList = otherCountryList.stream()                // convert list to stream
                .filter(line -> !Arrays.asList(PREFERRED_COUNTRY_CODES).stream().anyMatch(pcode->pcode.equalsIgnoreCase((String)line.getLabel())))     // we dont like mkyong
...
class SelectItem implements Serializable {
    ...
    public enum CountryCode {
        ...
        AL("AL", "Albanien", "Albania", "Albanie", "Albania"),
        AM("AM", "Armenien", "Armenia", "Arménie", "Armenia"),
        ...
        BG("BG", "Bulgarien", "Bulgaria", "Bulgarie", "Bulgaria"),
        BH("BH", "Bahrein", "Bahrain", "Bahreïn", "Bahrein"),
        ...
        BO("BO", "Bolivien", "Bolivia", "Bolivie", "Bolivia"),
        BR("BR", "Brasilien", "Brazil", "Brésil", "Brasile"),
        BS("BS", "Bahamas", "Bahamas", "Bahamas", "Bahama"),
        BT("BT", "Bhutan", "Bhutan", "Bhoutan", "Bhutan"),
        ...
        BZ("BZ", "Belize", "Belize", "Belize", "Belize"),
        CA("CA", "Kanada", "Canada", "Canada", "Canada"),
        ...
        CK("CK", "Cook", "Cook Islands", "Cook", "Cook"),
        CL("CL", "Chile", "Chile", "Chili", "Cile"),
        CM("CM", "Kamerun", "Cameroon", "Cameroun", "Camerun"),
        CN("CN", "China", "China", "Chine", "Cina"),
        CO("CO", "Kolumbien", "Colombia", "Colombie", "Colombia"),
        CR("CR", "Costa Rica", "Costa Rica", "Costa Rica", "Costarica"),
        CU("CU", "Kuba", "Cuba", "Cuba", "Cuba"),
        ...
        DY("DY", "Benin", "Benin", "Bénin", "Benin"),
        DZ("DZ", "Algerien", "Algeria", "Algérie", "Algeria"),
        EC("EC", "Ecuador", "Ecuador", "Equateur", "Ecuador"),
        EE("EE", "Estland", "Estonia", "Estonie", "Estonia"),
        EG("EG", "Aegypten", "Egypt", "Egypte", "Egitto"),
        EH("EH", "Westsahara", "Western Sahara", "Sahara occidental", "Sahara Occidentale"),
        ER("ER", "Eritrea", "Eritrea", "Erythrée", "Eritrea"),
        ES("ES", "Spanien", "Spain", "Espagne", "Spagna"),
        ET("ET", "Aethiopien", "Ethiopia", "Ethiopie", "Etiopia"),
        FI("FI", "Finnland", "Finland", "Finlande", "Finlandia"),
        FJ("FJ", "Fidschi", "Fiji", "Fidji", "Figi"),
        ...
        FM("FM", "Mikronesien (Karolinen)", "Micronesia Federated States of", "Micronésie (Carolines)", "Micronesia (Caroline)"),
        ...
        GD("GD", "Grenada", "Grenada", "Grenade", "Grenada"),
        GE("GE", "Georgien", "Georgia", "Géorgie", "Georgia"),
        GF("GF", "Franz. Guayana", "French Guiana", "Guyane française", "Guiana Francese"),
        GG("GG", "Guernsey (Kanalinsel)", "Guernesey", "Guernesey", "Guernsey"),
        GH("GH", "Ghana", "Ghana", "Ghana", "Ghana"),
        GI("GI", "Gibraltar", "Gibraltar", "Gibraltar", "Gibilterra"),
        GL("GL", "Grönland", "Greenland", "Groenland", "Groenlandia"),
        GM("GM", "Gambia", "Gambia", "Gambie", "Gambia"),
        ...
        GT("GT", "Guatemala", "Guatemala", "Guatemala", "Guatemala"),
        GU("GU", "Guam", "Guam", "Guam", "Guam"),
        GW("GW", "Guinea-Bissau", "Guinea-Bissau", "Guinée-Bissau", "Guinea Bissau"),
        GY("GY", "Guayana", "Guyana", "Guyane", "Guiana"),
        HK("HK", "Hongkong", "Hong Kong", "Hongkong", "Hongkong"),
        HM("HM", "Heard und McDonaldinseln", "Heard and Mc Donald Islands", "Île Heard et îles McDonald", "Isole Heard e McDonald"),
        HN("HN", "Honduras", "Honduras", "Honduras", "Honduras"),
        HR("HR", "Kroatien", "Croatia", "Croatie", "Croazia"),
        HU("HU", "Ungarn", "Hungary", "Hongrie", "Ungheria"),
        IL("IL", "Israel", "Israel", "Israël", "Israele"),
        IM("IM", "Insel Man", "Isle of Man", "Île de Man", "Isola di Man"),
        IN("IN", "Indien", "India", "Inde", "India"),
        IO("IO", "Brit. Jungfern Inseln", "British Indian Ocean Territory", "Vierges britanniques", "Vergini britannica"),
        IQ("IQ", "Irak", "Iraq", "Iraq", "Iraq"),
        IR("IR", "Iran", "Iran (Islamic Republic of)", "Iran", "Iran"),
        IE("IE", "Irland", "Ireland", "Irlande", "Irlanda"),
        IS("IS", "Island", "Iceland", "Islande", "Islanda"),
        // IT("IT","Italien","Italy","Italie","Italia"),
        JA("JA", "Jamaika", "Jamaica", "Jamaïque", "Giamaica"),
        JE("JE", "Jersey (Kanalinsel)", "Jersey", "Jersey", "Jersey"),
        JO("JO", "Jordanien", "Jordan", "Jordanie", "Giordania"),
        JP("JP", "Japan", "Japan", "Japon", "Giappone"),
        KE("KE", "Kenia", "Kenya", "Kenya", "Kenya"),
        KG("KG", "Kirgistan", "Kyrgyzstan", "Kirgistan", "Kirgistan"),
        ...
        KS("KS", "Kosovo", "Kosovo", "Kosovo", "Kosovo"),
        KW("KW", "Kuwait", "Kuwait", "Koweït", "Kuwait"),
        ...
        LS("LS", "Lesotho", "Lesotho", "Lesotho", "Lesotho"),
        LT("LT", "Litauen", "Lithuania", "Lituanie", "Lituania"),
        LU("LU", "Luxemburg", "Luxembourg", "Luxembourg", "Lussemburgo"),
        LV("LV", "Lettland", "Latvia", "Lettonie", "Lettonia"),
        LY("LY", "Libyen", "Libya", "Libye", "Libia"),
        MA("MA", "Marokko", "Marocco", "Maroc", "Marocco"),
        MC("MC", "Monaco", "Monaco", "Monaco", "Monaco"),
        ...
        MK("MK", "Mazedonien", "Macedonia", "Macédoine", "Macedonia"),
        ML("ML", "Mali", "Mali", "Mali", "Mali"),
        MM("MM", "Myanmar (Burma)", "Myanmar", "Myanmar (Birmanie)", "Myanmar (Birmania)"),
        MN("MN", "Mongolei", "Mongolia", "Mongolie", "Mongolia"),
        MO("MO", "Macao", "Macau", "Macao", "Macao"),
        ...
        MS("MS", "Montserrat", "Montserrat", "Montserrat", "Montserrat"),
        MT("MT", "Malta", "Malta", "Malte", "Malta"),
        MU("MU", "Mauritius", "Mauritius", "Maurice", "Maurizio"),
        MV("MV", "Malediven", "Maldives", "Maldives", "Maldive"),
        MW("MW", "Malawi", "Malawi", "Malawi", "Malawi"),
        MX("MX", "Mexiko", "Mexico", "Mexique", "Messico"),
        MY("MY", "Malaysia", "Malaysia", "Malaisie", "Malaisia"),
        ...
        NO("NO", "Norwegen", "Norway", "Norvège", "Norvegia"),
        NP("NP", "Nepal", "Nepal", "Népal", "Nepal"),
        NR("NR", "Nauru", "Nauru", "Nauru", "Nauru"),
        NU("NU", "Niue", "Niue", "Niue", "Niue"),
        NZ("NZ", "Neuseeland", "New Zealand", "Nouvelle-Zélande", "Nuova Zelanda"),
        OM("OM", "Oman", "Oman", "Oman", "Oman"),
        PA("PA", "Panama", "Panama", "Panama", "Panama"),
        ...
        PK("PK", "Pakistan", "Pakistan", "Pakistan", "Pakistan"),
        PL("PL", "Polen", "Poland", "Pologne", "Polonia"),
        PM("PM", "St. Pierre und Miquelon", "Saint Pierre and Miquelon", "St-Pierre et Miquelon", "Saint-Pierre e Miquelon"),
        ...
        PT("PT", "Portugal", "Portugal", "Portugal", "Portogallo"),
        PW("PW", "Palau", "Palau", "Palau", "Palau"),
        PY("PY", "Paraguay", "Paraguay", "Paraguay", "Paraguay"),
        QA("QA", "Qatar", "Qatar", "Qatar", "Qatar"),
        RA("RA", "Argentinien", "Argentina", "Argentine", "Argentina"),
        RC("RC", "Taiwan", "Taiwan", "Taiwan", "Taiwan"),
        RE("RE", "Reunion", "Réunion", "Réunion", "Riunione"),
        RH("RH", "Haiti", "Haiti", "Haïti", "Haiti"),
        RI("RI", "Indonesien", "Indonesia", "Indonésie", "Indonesia"),
        RL("RL", "Libanon", "Lebanon", "Liban", "Libano"),
        RM("RM", "Madagaskar", "Madagascar", "Madagascar", "Madagascar"),
        RN("RN", "Niger", "Niger", "Niger", "Niger"),
        ...
        SC("SC", "Seychellen", "Seychelles", "Seychelles", "Seicelle"),
        SD("SD", "Sudan", "Sudan", "Soudan", "Sudan"),
        ...
        SJ("SJ", "Svalbard und Jan Mayen", "Svalbard and Jan Mayen", "Svalbard et île Jan Mayen", "Svalbard e Jan Mayen"),
        ...
        SN("SN", "Senegal", "Senegal", "Sénégal", "Senegal"),
        SO("SO", "Somalia", "Somalia", "Somalie", "Somalia"),
        ...
        SW("SW", "Schweden", "Sweden", "Suède", "Svezia"),
        SY("SY", "Syrien", "Syrian Arab Republic", "Syrie", "Siria"),
        ...
        TF("TF", "Französische Süd- und Antarktisgebiete", "French Southern Territories", "Terres australes et antarctiques françaises",
                "Terre Australi e Antartiche Francesi"),
        TG("TG", "Togo", "Togo", "Togo", "Togo"),
        TH("TH", "Thailand", "Thailand", "Thaïlande", "Tailandia"),
        ...
        TN("TN", "Tunesien", "Tunisia", "Tunisie", "Tunisia"),
        TO("TO", "Tonga", "Tonga", "Tonga", "Tonga"),
        ...
        UA("UA", "Ukraine", "Ukraine", "Ukraine", "Ucraina"),
        UG("UG", "Uganda", "Uganda", "Ouganda", "Uganda"),
        ...
        VG("VG", "Britische Jungferninseln", "Virgin Islands (British)", "Îles Vierges britanniques", "Isole Vergini britanniche"),
        VI("VI", "Amerik. Jungfern-Ins.", "Virgin Islands (U.S.)", "Îles Vierges américaines", "Vergini, statunitense"),
        VN("VN", "Vietnam", "Vietnam", "Viét-Nam", "Vietnam"),
        VU("VU", "Vanuatu", "Vanuatu", "Vanuatu", "Vanuatu"),
        ...
        YU("YU", "Serbien/Montenegro", "Serbia and Montenegro the state union of", "Serbie/Monténégro", "Serbia/Montenegro"),
        YV("YV", "Venezuela", "Venezuela", "Vénézuéla", "Venezuela"),
        ZA("ZA", "Südafrika", "South Africa", "Afrique du Sud", "Sudafrica"),
        ZM("ZM", "Sambia", "Zambia", "Zambie", "Zambia"),
        ZW("ZW", "Zimbabwe", "Zimbabwe", "Zimbabwe", "Zimbabwe"),
